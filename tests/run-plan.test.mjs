...
test("normalizeScenarioIds accepts comma-separated and repeated values", () => {
  assert.deepEqual(normalizeScenarioIds(["session-switch-v1", "app-start-v1,session-switch-v1"]), [
    "session-switch-v1",
    "app-start-v1",
  ]);
...
test("run plan resolves a smoke single-scenario layout for claxedo", async () => {
  ...
  try {
    ...
    assert.deepEqual(plan.scenarioIds, ["session-switch-v1"]);
